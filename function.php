...
function tambah($data){
    ...
    $query = "INSERT INTO mahasiswa VALUES ('', $nrp, '$gambar', '$nama', '$email', '$jurusan')";
...
function ubah($data){
    ...
    $query = "UPDATE mahasiswa SET npm = '$nrp', gambar = '$gambar', nama = '$nama', email = '$email', jurusan = '$jurusan' WHERE id = $id";
    mysqli_query($conn, $query);
